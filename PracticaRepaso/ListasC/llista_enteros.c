...
int intercambiar(tipo_lista lista, int pos1, int pos2){
	...
	int aux;
	nodo cursorPos1 = lista->cabeza;
	nodo cursorPos2 = lista->cabeza;

	for ( int i = 0; i < pos1 ; i++ ){
		cursorPos1 = cursorPos1->siguiente;	
	};
	for ( int i = 0; i < pos2 ; i++ ){
		cursorPos2 = cursorPos2->siguiente;	
	};

	aux = cursorPos1->valor;
	cursorPos1->valor = cursorPos2->valor;
	cursorPos2->valor = aux;
